...
const SEO_COPY = {
  de: {
    title: 'eSIM für Reisen – Tarife vergleichen',
    description: 'Vergleiche Reise-eSIMs, finde den passenden Datentarif für dein Reiseziel und geh direkt nach der Landung online.',
  },
  en: {
    title: 'Travel eSIM – Compare Data Plans',
    description: 'Compare travel eSIMs, find the right data plan for your destination and get online as soon as you land.',
  },
  zh: {
    title: '旅行 eSIM — 套餐对比',
    description: '对比旅行 eSIM 套餐，为目的地挑选合适的流量方案，落地即可上网。',
  },
}
