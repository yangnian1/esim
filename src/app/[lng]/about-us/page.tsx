...
const translations: Record<string, Record<string, string>> = {
  en: {
    title: 'About Us',
    subtitle: 'Hi, we are eSIM Store',
    tagline: 'No.1 Tourist eSIM Provider for Travelers Worldwide',
    description: 'eSIM Store is a digital service provider that offers eSIM cards to travelers worldwide, making it easier and much more convenient for them to stay connected during their trip.',
    description2: 'Whether you\'re looking to browse the web, stay in touch with loved ones, or navigate the city with ease, eSIM technology has the potential to enhance your travel experience. That is where eSIM Store comes in.',
    ...
    international_text: 'eSIM Store is an international eSIM provider offering services to a wide range of countries including those in Asia, Europe, Oceania, and Africa, etc. eSIM Store offers a convenient solution for travelers seeking to avoid the hassle of physical SIM cards and roaming charges. With global coverage and user-friendly platform, eSIM Store is an excellent option for frequent travelers and digital nomads looking for a seamless eSIM experience.',
  ...
  zh: {
    title: '关于我们',
    subtitle: '你好，我们是 eSIM Store',
    tagline: '全球旅行者首选 eSIM 服务提供商',
    description: 'eSIM Store 是一家数字服务提供商，为全球旅行者提供 eSIM 卡，让您在旅途中更轻松、更方便地保持连接。',
    description2: '无论您是想浏览网页、与亲人保持联系，还是轻松导航城市，eSIM 技术都能提升您的旅行体验。这就是 eSIM Store 的用武之地。',
    ...
    international_text: 'eSIM Store 是一家国际 eSIM 提供商，为包括亚洲、欧洲、大洋洲和非洲等在内的多个国家提供服务。eSIM Store 为寻求避免实体 SIM 卡和漫游费用麻烦的旅行者提供便捷的解决方案。凭借全球覆盖和用户友好的平台，eSIM Store 是寻求无缝 eSIM 体验的频繁旅行者和数字游民的绝佳选择。',
  ...
  vi: {
    title: 'Về Chúng Tôi',
    subtitle: 'Xin chào, chúng tôi là eSIM Store',
    tagline: 'Nhà cung cấp eSIM du lịch số 1 cho du khách toàn cầu',
    description: 'eSIM Store là nhà cung cấp dịch vụ kỹ thuật số cung cấp thẻ eSIM cho du khách trên toàn thế giới, giúp họ dễ dàng và thuận tiện hơn trong việc duy trì kết nối trong chuyến đi.',
    description2: 'Cho dù bạn muốn duyệt web, giữ liên lạc với người thân hay điều hướng thành phố một cách dễ dàng, công nghệ eSIM có tiềm năng nâng cao trải nghiệm du lịch của bạn. Đó là nơi eSIM Store xuất hiện.',
    ...
    international_text: 'eSIM Store là nhà cung cấp eSIM quốc tế cung cấp dịch vụ cho nhiều quốc gia bao gồm các quốc gia ở Châu Á, Châu Âu, Châu Đại Dương và Châu Phi, v.v. eSIM Store cung cấp giải pháp tiện lợi cho du khách tìm cách tránh rắc rối với thẻ SIM vật lý và phí chuyển vùng. Với phạm vi phủ sóng toàn cầu và nền tảng thân thiện với người dùng, eSIM Store là lựa chọn tuyệt vời cho những du khách thường xuyên và digital nomad đang tìm kiếm trải nghiệm eSIM liền mạch.',
  ...
  de: {
    title: 'Über Uns',
    subtitle: 'Hallo, wir sind eSIM Store',
    tagline: 'Nr. 1 Tourist eSIM Anbieter für Reisende weltweit',
    description: 'eSIM Store ist ein digitaler Dienstleister, der eSIM-Karten für Reisende weltweit anbietet und es ihnen erleichtert, während ihrer Reise verbunden zu bleiben.',
    description2: 'Egal, ob Sie im Internet surfen, mit Ihren Lieben in Kontakt bleiben oder die Stadt mühelos navigieren möchten, eSIM-Technologie kann Ihr Reiseerlebnis verbessern. Hier kommt eSIM Store ins Spiel.',
    ...
    international_text: 'eSIM Store ist ein internationaler eSIM-Anbieter, der Dienstleistungen für eine Vielzahl von Ländern anbietet, einschließlich solcher in Asien, Europa, Ozeanien und Afrika usw. eSIM Store bietet eine praktische Lösung für Reisende, die den Ärger mit physischen SIM-Karten und Roaming-Gebühren vermeiden möchten. Mit globaler Abdeckung und benutzerfreundlicher Plattform ist eSIM Store eine ausgezeichnete Option für Vielflieger und digitale Nomaden, die ein nahtloses eSIM-Erlebnis suchen.',
